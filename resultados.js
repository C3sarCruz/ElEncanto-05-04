...
function cerrarGS() {
 ...
 function muestra_55(id) {
        ...
        window.onload = function () {
            muestra_GS('contenido55');
}

 function muestra_11(id) {
        if (document.getElementById) {
            var el = document.getElementById(id);
        el.style.display = (el.style.display == 'none') ? 'block' : 'none';
        }
        ...
        window.onload = function () {
            muestra_GS('contenido11');
}

 function muestra_13(id) {
        if (document.getElementById) {
            var el = document.getElementById(id);
        el.style.display = (el.style.display == 'none') ? 'block' : 'none';
        }
        ...
        window.onload = function () {
            muestra_GS('contenido13');
}

 function muestra_9(id) {
        if (document.getElementById) {
            var el = document.getElementById(id);
        el.style.display = (el.style.display == 'none') ? 'block' : 'none';
        }
        ...
        window.onload = function () {
            muestra_GS('contenido9');
}

 function muestra_12(id) {
        if (document.getElementById) {
            var el = document.getElementById(id);
        el.style.display = (el.style.display == 'none') ? 'block' : 'none';
        }
